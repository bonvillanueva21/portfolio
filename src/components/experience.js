      ...
      {experience.map((experience, index) => (
        ...
        >
          <div className="w-full md:w-1/4">
            <p className="text-gray-700 dark:text-gray-400 text-base mb-2">{experience.year}</p>
          </div>
          <div className="w-full max-w-xl md:w-3/4">
            <h6 className="mb-2 font-semibold text-gray-700 dark:text-gray-300">
              {experience.role} -{" "}
              <span className="text-base text-gray-700 dark:text-gray-300 font-normal">{experience.company}</span>
            </h6>
