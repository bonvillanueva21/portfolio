...
function Navbar() {
  return (
    <nav className="flex items-center justify-between md:mb-10 py-6 px-4 md:px-8 sticky top-0 z-50 bg-opacity-60 backdrop-blur-lg  mix-blend-difference">
      ...
      <ul className="flex space-x-6 text-white hover:text-gray-100 font-semibold tracking-widest uppercase">
        ...
        <li className="text-xs md:text-base text-white hover:text-gray-400 transition cursor-pointer">
